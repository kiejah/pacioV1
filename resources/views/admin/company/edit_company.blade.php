            ...
            <form role="form" method="POST" action="{{ route('admin.company.update',$company->id) }}" id="company-form">
                ...
                <div class="row">
                    <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">{{$area_type_name}}</label>
                                <select class="form-control" name="area_id" id="company_country_id">

                                    <option selected value="{{$company->area_id}}">{{$company->area->area_name}}</option>
